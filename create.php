...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $title = $_POST["title"];
        $genre = $_POST["genre"];
        // Get the selected values for hours and minutes
    $duration_hours = $_POST["duration_hours"];
    $duration_minutes = $_POST["duration_minutes"];

    // Check if the user selected 60 minutes and adjust hours accordingly
...
// Now you can use $duration in your SQL query or other processin
